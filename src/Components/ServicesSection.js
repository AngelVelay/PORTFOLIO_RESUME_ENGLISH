      ...
      <ServicesSectionStyled>
        ...
        <div className="services">
          <ServiceCard
            ...
            paragraph={
              "Knowledge using React JS, experience using functional components and Hooks | REDUX"
            }
          />
          <div className="mid-card">
            <ServiceCard
              ...
              title={"Node JS"}
              paragraph={
                "Knowledge in the realization of REST APIs using Express JS and how to use it in frontend"
              }
            />
          </div>
          <ServiceCard
          ...
          <ServiceCard
            image={java}
            title={"Java"}
            paragraph={"Experience using POO in Java"}
          />
          <ServiceCard
            image={python}
            title={"Python"}
            paragraph={
              "Experience in Python programming and using the FLASK framework for the realization of REST APIs"
            }
          />
          <ServiceCard
            image={mongo}
