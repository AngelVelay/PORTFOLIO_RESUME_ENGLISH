...
const blogs = [
    {
        id: 1,
        title: 'TaskQ',
        content: 'Application for task and project management. The frontend was made in React and the backend with NODE JS (Express JS).',
        date: '01',
        month: 'April',
        image: blog1,
    ...
    },
    {
        id: 3,
        title: 'Music Search',
        content: 'REACT application to search a band´s biography and song lyrics using the AudioDB API and LyricsOVH',
        date: '01',
        month: 'April',
        image: blog3,
  ...
  
    {
        id: 4,
        title: 'CriptoCoin',
        content: 'Application to consult the Price and Rate Exchange of Cryptocurrencies using the CoinGecko API.',
        date: '01',
        month: 'April',
        image: blog5,
    ...
    },
    {
        id: 6,
        title: 'CrytoBT',
        content: 'Application to check the real-time price of different cryptocurrencies made in React Native and uses the CoinGecko API.',
        date: '01',
        month: 'April',
        image: blog4,
